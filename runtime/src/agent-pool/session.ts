...
const OPTIONAL_EXTENSIONS: OptionalBundledExtension[] = [
  ...
  { path: resolve(EXTENSIONS_DIR, "integrations", "gmail-channel", "index.ts") },
  { path: resolve(EXTENSIONS_DIR, "integrations", "google-calendar", "index.ts") },
  { path: resolve(EXTENSIONS_DIR, "integrations", "personal-memory", "index.ts") },
