...
export async function resizeImage(input, options = {}) {
    const { maxWidth = 800, maxHeight = 800, quality = 80, format = "webp", } = options;
    try {
 ...
 * Returns null if processing fails.
 */
export async function processAvatar(input, options = {}) {
 ...
 * Returns null if processing fails.
 */
export async function optimizeLinkPreviewImage(input, options = {}) {
    return resizeImage(input, {
