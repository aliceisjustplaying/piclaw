 ...
 */
export function isPathWithin(baseDir, filePath) {
 ...
 */
export function stripBaseDirForDisplay(baseDir, absolutePath) {
 ...
 */
export function isRealPathWithin(realBaseDir, realPath) {
