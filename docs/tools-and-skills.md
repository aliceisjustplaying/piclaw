...
- `send_dashboard_widget` — post an interactive widget with agent-authored HTML to the web timeline (opens in floating pane; supports Three.js via vendored import)
