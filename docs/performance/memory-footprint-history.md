...
|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 2026-04-18T07:24:41Z | `ba263474` | no | Live `piclaw.service` after the recent RAM-work reload and the later 07:21Z restart, measured under light interactive load | 262.4 MB | 261.1 MB | 282.6 MB | 299.0 MB | 91.5 MB | 56.7 MB | 2 | 2 | 0 | Service PID 92967 on `:8080`. Runtime counters at capture time: `create_in_flight=0`, `prewarm_in_flight=0`, `queued_prewarms=0`. The restart emitted `.piclaw/data/startup-memory-snapshots/2026-04-18T07-21-23-155Z_post-web-start.json`, a fresh post-start sample at 216.7 MB RSS / 38.8 MB heap / 15.9 MB external with `cached_main_sessions=0` and `active_chats=0`. By 07:24Z the live process had grown under two active chats and two cached main sessions, so treat this as the first post-reload interactive checkpoint rather than a new idle low-water mark. |
